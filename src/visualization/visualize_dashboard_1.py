...
import os
print(os.getcwd())
df_input_large=pd.read_csv('C:/Users/thire/Desktop/eds_lodaya_406410_covid_19/data/processed/COVID_final_set.csv',sep=';')
...
app.layout = html.Div([
    ...
    * Goal of the project is to learn data science by applying a cross-industry standard process.\
    ...
    dcc.Dropdown(
        ...
        value=['US', 'India','Brazil'], # which are pre-selected
        multi=True
    ),
